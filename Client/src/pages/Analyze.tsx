    ...
    const handleAnalyze = async (submitUrl?: string) => {
        ...
        try {
            ...
            pollRef.current = setInterval(async () => {
                ...
                try {
                    // IMPORTANT:
                    // Use backticks so ${id} is replaced with the real ID
                    ...
                    if (analysis.status === "completed") {
                        ...
                        setError(
                            "Analysis failed. The AI model may be down"
                        );
                        ...
                        // Still processing
                        // Advance visual steps after some polling attempts
                        if (attempts > 5) {
                            setCurrentStep(2);
                        }
                    }
                    ...
                    <div>
                        ...
                        <div className="text-center mb-10 mt-24">
                            ...
                            <p className="text-muted-foreground">
                                Enter a URL to get a comprehensive AI-powered
                                SEO audit report.
                            </p>
                        </div>
